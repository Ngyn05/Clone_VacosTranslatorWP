...
<img alt="" aria-hidden="true" src="<?php echo esc_url( VASCO_THEME_URI . "/assets/img/features/text-new-1.webp" ); ?>"/>
</div>
</div>
</div>
...
<div class="voice-img-box">
<img alt="" aria-hidden="true" src="<?php echo esc_url( VASCO_THEME_URI . "/assets/img/features/text-new-3.webp" ); ?>"/>
</div>
</div>
</div>
<div class="voice-box-wrapper" style="background-color: #EFECE8;">
...
<div>
<a class="btn btn-md btn-secondary" href="./translate-voice.html">XEM TÍNH NĂNG TIẾP THEO</a>
</div>
</div>
</section>
</section>
