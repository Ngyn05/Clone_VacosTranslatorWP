<?php
/**
 * Template Name: Clean Page page-packages.php
 *
 * @package VascoTheme
 */
...
<li>
<span aria-current="page" class="breadcrumb-current">Gói sản phẩm</span>
</li>
</ol>
</nav>
</div>
...
<div class="container">
<nav class="tab-menu">
<a aria-label="Máy dịch" class="menu-link" href="<?php echo esc_url( home_url( "/translators/" ) ); ?>">Máy dịch</a><a aria-label="Bộ sản phẩm" class="menu-link" href="<?php echo esc_url( home_url( "/bundles/" ) ); ?>">Bộ sản phẩm</a><a aria-label="Phụ kiện" class="menu-link" href="<?php echo esc_url( home_url( "/accessories/" ) ); ?>">Phụ kiện</a><a aria-label="Tất cả sản phẩm" class="menu-link" href="<?php echo esc_url( home_url( "/all-products/" ) ); ?>">Tất cả sản phẩm</a><a aria-label="Gói sản phẩm" class="menu-link current" href="<?php echo esc_url( home_url( "/packages/" ) ); ?>">Gói sản phẩm</a>
</nav>
</div>
</div>
...
<article aria-labelledby="phone-call-translator-top-up-name" class="product-miniature js-product-miniature" data-id-product="65" data-id-product-attribute="80" tabindex="0">
...
<input id="product_page_product_id" name="id_product" type="hidden" value="65"/>
...
<p class="sr-only" id="legend-package">
</p>
<div aria-labelledby="legend-package" class="product-variants-list" id="group_6" role="radiogroup">
<label aria-checked="true" class="input-container product-variants-item" data-product-id="65" role="radio" tabindex="0">
<input checked="checked" class="input-radio" data-analytics-type="other" name="group[6]" title="10" type="radio" value="1010"/>
<span class="radio-label">10</span>
</label>
<label aria-checked="false" class="input-container product-variants-item" data-product-id="65" role="radio" tabindex="0">
<input class="input-radio" data-analytics-type="other" name="group[6]" title="50" type="radio" value="1011"/>
<span class="radio-label">50</span>
</label>
<label aria-checked="false" class="input-container product-variants-item" data-product-id="65" role="radio" tabindex="0">
<input class="input-radio" data-analytics-type="other" name="group[6]" title="100" type="radio" value="1012"/>
...
<span aria-label="Giá gốc $7" class="regular-price" data-text="Regular price"></span>
</span>
<span aria-label="Giá $7" class="price">
																																											$7																											</span>
</div>
</div>
</div>
