...
<h1 class="h1">Vượt rào cản. Vượt ngôn từ. Vượt mọi giới hạn.</h1>
<p class="subtitle">Chúng tôi giúp cả thế giới nói cùng một tiếng nói</p>
<p> Bạn có còn nhớ thế giới công nghệ trông như thế nào vào năm 2008 không? Mỗi buổi xem phim đều bắt đầu bằng ánh sáng lấp lánh của đĩa DVD. Trước khi máy nghe nhạc MP3 có thể phát bài hát yêu thích của bạn, bạn phải vật lộn với một mớ tai nghe rối tung. Điện thoại thông minh chỉ mới bắt đầu khơi dậy trí tưởng tượng của chúng ta, và mạng xã hội vẫn chưa trở thành một thế giới song song.</p>
<p>Ngày nay, tất cả những điều đó đã trở thành lẽ tự nhiên—bởi vì ai đó, vào một thời điểm nào đó, đã có một ý tưởng hay. Và rồi họ đã không bỏ cuộc.</p>
<div>
</div>
...
<p class="vjs-no-js">
								Để xem video này, vui lòng bật JavaScript và xem xét nâng cấp lên
								trình duyệt web
...
<p class="sr-only" id="video-desc-hero">
							Logo Vasco hoạt hình với các chữ cái đầu ‘VA’ xoay tròn; hoạt ảnh kết thúc bằng câu slogan: ‘Vượt rào cản. Vượt ngôn từ. Vượt mọi giới hạn.’
						</p>
</div>
</div>
</div>
...
<div class="swiper-button-next btn-events-next" data-label-next="Slide tiếp theo"></div>
</div>
</div>
</div>
</section>
...
<h2 class="h2-notosans">Chúng tôi không làm điều này vì giải thưởng. Chúng tôi làm vì con người.</h2>
<div aria-label="trình chiếu các giải thưởng" aria-roledescription="carousel" class="swiper swiper-carousel autoplay loop carousel-award" role="region">
<a class="sr-only focusable" href="#after-award-carousel">Bỏ qua trình chiếu</a>
...
<h3 class="h2-notosans">Nhưng chúng chứng minh rằng chúng tôi đang đi đúng hướng.</h3>
</div>
</div>
</section>
...
<div aria-label="trình chiếu các trích dẫn" aria-roledescription="carousel" class="swiper swiper-carousel autoplay loop carousel-media">
<a class="sr-only focusable" href="#after-media-carousel">Bỏ qua trình chiếu</a>
<div class="swiper-wrapper">
...
<blockquote class="awards-text" tabindex="0">Tôi nghĩ Vasco là sản phẩm tốt nhất trong số đó vì nó đi kèm dữ liệu không giới hạn trọn đời (không cần tìm Wi-Fi!) và phiên dịch 108 ngôn ngữ tại 200 quốc gia khác nhau.</blockquote>
</a>
</div>
<div class="swiper-slide" role="listitem">
...
<div class="btn-wrapper">
<button class="btn btn-md btn-black active" data-feature="Vasco assistant" data-section="product_features_click">Vasco Assistant</button>
<button class="btn btn-md btn-black" data-feature="Vasco audience" data-section="product_features_click">Vasco Audience</button>
</div>
<div class="section-scroll-wrapper">
<div class="slide s1">
<div class="container">
<div class="media">
<img alt="Máy dịch Vasco Q1 hiển thị tính năng Vasco Assistant trên màn hình — cho thấy ảnh một món ăn và mô tả do AI tạo ra về món ăn xuất hiện trong hình." src="<?php echo esc_url( VASCO_THEME_URI . "/assets/img/q1/vasco-assistant.webp" ); ?>"/>
</div>
<div class="tech-info">
<h3>Vasco Assistant</h3>
<p>Một chương mới trong việc xây dựng những cây cầu kết nối giữa các nền văn hóa. Được hỗ trợ bởi AI, Vasco Assistant không chỉ dịch—mà còn giải thích. Ví dụ, nó có thể cho bạn biết “pad kra pao” thực sự là gì trong thực đơn Thái Lan, hay liệu từ jayus trong tiếng Indonesia có giống với “dad joke” (câu đùa kiểu bố) của chúng ta không. Nó hiểu được ý nghĩa ẩn giấu trong bối cảnh văn hóa và những sắc thái đời thường, nhận biết thành ngữ, biểu tượng, ẩm thực địa phương và phong tục tập quán—tạo nên cầu nối giữa ngôn từ và ý nghĩa sâu xa của chúng.</p>
</div>
</div>
</div>
<div class="slide s2">
<div class="container">
<div class="media">
<img alt="Màn hình lớn trong phòng hội nghị hiển thị hướng dẫn “Join Vasco Audience”, cho người tham gia biết cách truy cập vào phiên họp." src="<?php echo esc_url( VASCO_THEME_URI . "/assets/img/q1/vasco-audience.webp" ); ?>"/>
</div>
<div class="tech-info">
...
<div aria-label="trình chiếu logo của các công ty đã tin tưởng chúng tôi" aria-roledescription="carousel" class="trustedby-logo-carousel" role="region">
<a class="sr-only focusable" href="#after-trustedby-logo-carousel">Bỏ qua trình chiếu</a>
...
<h2 class="h2-notosans" id="vasco-products-heading">Trở thành một phần của bước đột phá. Lựa chọn Máy phiên dịch Vasco của bạn</h2>
