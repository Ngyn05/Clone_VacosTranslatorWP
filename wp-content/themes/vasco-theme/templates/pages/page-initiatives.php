...
<a class="btn btn-md btn-black" href="<?php echo esc_url( home_url( '/initiatives/polish-medical-mission-pmm/' ) ); ?>">Tìm hiểu thêm <span class="text-sr-only">về Đội Cứu hộ Khẩn cấp PMM Vasco</span></a>
</div>
<div class="si-image">
...
<a class="btn btn-md btn-black" href="<?php echo esc_url( home_url( '/initiatives/quinnipiac/' ) ); ?>">Tìm hiểu thêm <span class="text-sr-only">về sự hợp tác với Đại học Quinnipiac</span></a>
</div>
</div>
...
<a class="btn btn-md btn-black" href="<?php echo esc_url( home_url( '/initiatives/help-ukraine/' ) ); ?>">Tìm hiểu thêm <span class="text-sr-only">về cách Vasco đã giúp đỡ Ukraine</span></a>
</div>
<div class="si-image">
